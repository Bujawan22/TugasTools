...
<div class="container mt-3">
    ...
    <form action="" method="post">
        <table class="table table-bordered" style="background-color: rgba(108, 117, 125, 0.5); color: white;">
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Simpan" name="proses_pelanggan" class="btn btn-success"></td>
            </tr>
        </table>
    </form>
    ...
    <?php
    include "koneksi.php";
    echo '<h3 style="color: white;"> Data Pelanggan </h3>';
...
<?php
    ...
    <div id="result_pelanggan">
        <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus_pelanggan_id'])) {
            echo '<p style="color:white;">Data pelanggan berhasil dihapus.</p>';
        }
        ?>
    </div>
    ...
    <form action="" method="post">
        ...
        <table class="table table-bordered" style="background-color: rgba(108, 117, 125, 0.5); color: white;">
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Update" name="proses_edit_pelanggan" class="btn btn-warning"></td>
            </tr>
        </table>
        <?php } ?>
    </form>
    ...
    if (isset($_POST['proses_edit_pelanggan'])) {
        ...
        if ($hasil_update_pelanggan) {
            echo '<p style="color:white;">Data pelanggan berhasil diupdate.</p>';
        } else {
