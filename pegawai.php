...
<h3 style="color: white;"> Tabel pegawai</h3>
    ...
    <table class="table table-bordered" style="background-color: rgba(108, 117, 125, 0.5); color: white;">
            <tr>
                ...
                <td><input autocomplete="off" type="text" name="id_pegawai"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input autocomplete="off" type="text" name="alamat"></td>
            </tr>
            <tr>
                <td width="130">no telepon</td>
                <td><input autocomplete="off" type="text" name="no_telp"></td>
            </tr>
            <tr>
                <td></td>
...
<div id="result">
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus_id'])) {
        echo '<p style="color:white;">Data pegawai berhasil dihapus.</p>';
    }
    ?>
</div>
    ...
    if (isset($_POST['proses_edit'])) {
        ...
        if ($hasil_update) {
            echo '<p style="color:white;">Data pegawai berhasil diupdate.</p>';
        } else {
